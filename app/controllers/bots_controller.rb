class BotsController < ApplicationController
  ...
  # GET /bots/1.json
  def show
    graph = Koala::Facebook::API.new(@bot.page_access_token)

    @profile = graph.get_object("me")
    @messenger_profile = graph.get_object("me/messenger_profile?fields=greeting,get_started,persistent_menu")
  ...
  private
    ...
    def bot_params
      params.require(:bot).permit(:page_access_token)
    end
end
